use super::super::{
    Coordinates, Faces, HexConnectivity, Indices, NODE_NUMBERING_OFFSET, NodeMap, Octree,
    SubSubCellsFace, face_direction,
};
    ...
    template_inner(face_index).into_iter().for_each(
        |[
            ...
            if let Some(adjacent_cell) = cell_faces[adjacent_face] {
                ...
                {
                    if let Some(adjacent_cell_face_cell) = adjacent_cell_faces[face_index] {
                        ...
                        {
                            let lngth =
                                *tree[face_subsubcells[face_subsubcell_a]].get_lngth() as f64;
                            ...
                            element_node_connectivity.push([
                                ...
                                node_1,
                                node_2,
                                cells_nodes[adjacent_cell_subcells[adjacent_cell_subcell_a]],
                                cells_nodes[adjacent_cell_subcells[adjacent_cell_subcell_b]],
                                node_3,
                                node_4,
                            ]);
                            element_node_connectivity.push([
                                ...
                                node_2,
                                node_1,
                                cells_nodes[adjacent_face_subsubcells[adjacent_face_subsubcell_a]],
                                cells_nodes[adjacent_face_subsubcells[adjacent_face_subsubcell_b]],
                                node_4,
                                node_3,
                            ]);
                            element_node_connectivity.push([
                                ...
                                cells_nodes[cell_subcells[cell_subcell_a]],
                                cells_nodes[adjacent_cell_subcells[adjacent_cell_subcell_a]],
                                cells_nodes[adjacent_face_subsubcells[adjacent_face_subsubcell_d]],
                            ]);
                            element_node_connectivity.push([
                                cells_nodes[face_subsubcells[face_subsubcell_a]],
                                cells_nodes[adjacent_face_subsubcells[adjacent_face_subsubcell_a]],
                                ...
                                cells_nodes[adjacent_face_subsubcells[adjacent_face_subsubcell_c]],
                                cells_nodes[adjacent_cell_subcells[adjacent_cell_subcell_b]],
                                cells_nodes[cell_subcells[cell_subcell_b]],
                            ]);
                        }
