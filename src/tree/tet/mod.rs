    ...
    let element_node_connectivity = tree
        ...
        .flat_map(|leaf| match tree.neighbors_template(leaf) {
            ...
            [
                ...
                Neighbor::None,
                Neighbor::Edges(_),
            ] => connectivity_e0000e(leaf, indexed_nodes),
            [
                Neighbor::None,
                Neighbor::Edges(_),
                Neighbor::Edges(_),
            ...
            [
                ...
                Neighbor::Edges(_),
                Neighbor::None,
            ] => connectivity_0e00e0(leaf, indexed_nodes),
            [
                Neighbor::None,
                Neighbor::Edges(_),
                Neighbor::None,
            ...
            [
                ...
                Neighbor::Edges(_),
                Neighbor::None,
            ] => connectivity_00e0e0(leaf, indexed_nodes),
            [
                Neighbor::None,
                Neighbor::None,
                Neighbor::Edges(_),
            ...
            [
                ...
                Neighbor::None,
                Neighbor::Edges(_),
            ] => connectivity_000e0e(leaf, indexed_nodes),
            _ => {
        ...
        .for_each(|leaf| {
            ...
            match tree.neighbors_template(leaf) {
                ...
                [
                    ...
                    (0..8).for_each(|_| element_blocks.push(leaf.get_block()));
                    coordinates_e0000e(leaf).into_iter().for_each(|[i, j, k]| {
                        if indexed_nodes[i][j][k].is_none() {
                            indexed_coordinates.push([node_index, i, j, k]);
                            indexed_nodes[i][j][k] = Some(node_index);
                            node_index += 1;
                ...
                [
                    ...
                    (0..8).for_each(|_| element_blocks.push(leaf.get_block()));
                    coordinates_0e00e0(leaf).into_iter().for_each(|[i, j, k]| {
                        if indexed_nodes[i][j][k].is_none() {
                            indexed_coordinates.push([node_index, i, j, k]);
                            indexed_nodes[i][j][k] = Some(node_index);
                            node_index += 1;
                ...
                [
                    ...
                    (0..8).for_each(|_| element_blocks.push(leaf.get_block()));
                    coordinates_00e0e0(leaf).into_iter().for_each(|[i, j, k]| {
                        if indexed_nodes[i][j][k].is_none() {
                            indexed_coordinates.push([node_index, i, j, k]);
                            indexed_nodes[i][j][k] = Some(node_index);
                            node_index += 1;
                ...
                [
                    ...
                    (0..8).for_each(|_| element_blocks.push(leaf.get_block()));
                    coordinates_000e0e(leaf).into_iter().for_each(|[i, j, k]| {
                        if indexed_nodes[i][j][k].is_none() {
                            indexed_coordinates.push([node_index, i, j, k]);
                            indexed_nodes[i][j][k] = Some(node_index);
                            node_index += 1;
...
const fn coordinates_e0000e(cell: &Cell) -> [[usize; 3]; 1] {
    let [_, haf_x, _, min_y, _, _, _, _, max_z] = cell.get_all();
    [[haf_x, min_y, max_z]]
}
...
const fn coordinates_0e00e0(cell: &Cell) -> [[usize; 3]; 1] {
    let [_, _, max_x, _, haf_y, _, min_z, _, _] = cell.get_all();
    [[max_x, haf_y, min_z]]
}
...
const fn coordinates_00e0e0(cell: &Cell) -> [[usize; 3]; 1] {
    let [_, haf_x, _, _, _, max_y, min_z, _, _] = cell.get_all();
    [[haf_x, max_y, min_z]]
}
...
const fn coordinates_000e0e(cell: &Cell) -> [[usize; 3]; 1] {
    let [min_x, _, _, _, haf_y, _, _, _, max_z] = cell.get_all();
    [[min_x, haf_y, max_z]]
}
