...
This worked example applies [`remesh`](remesh.md) to an analytic unit sphere
...
the [Stanford bunny](remesh_bunny.md), where they differ.
...
> [Stanford bunny example](remesh_bunny.md) for a mesh where uniform and adaptive
