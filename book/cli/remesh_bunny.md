...
The [Unit sphere](remesh_sphere.md) page uses an analytic sphere, whose constant
...
[sphere example](remesh_sphere.md#relationship-to-triangular-subdivision) do **not**
hold here:
