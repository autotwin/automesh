...
acceptable ranges from Knupp *et al.*[^Knupp_2006], on its own page:

* [Hexahedral metrics](./metrics_hexahedral.md) — for eight-node brick elements:
  maximum edge ratio, minimum scaled Jacobian, maximum skew, and element volume.
* [Tetrahedral metrics](./metrics_tetrahedral.md) — for four-node tetrahedral
  elements: maximum edge ratio, minimum scaled Jacobian, maximum skew, and element
  volume.
* [Triangular metrics](./metrics_triangular.md) — for three-node triangular
  surface elements: maximum edge ratio, minimum scaled Jacobian, maximum skew,
  element area, and minimum angle.
