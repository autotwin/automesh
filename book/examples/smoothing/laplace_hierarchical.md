...
To begin to examine hierarchical control, we consider the [Bracket](../unit_tests/unit_tests.md#bracket) example.
...
Consider the `PRESCRIBED` and `BOUNDARY` node hierarchy below:
