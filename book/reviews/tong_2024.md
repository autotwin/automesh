...
The update moves $\mathbf{e}$ in the direction of the sum of the adjacent face normals.  The update effectively "pushes" node $\mathbf{e}$ out of the plane of its neighbors to maximize the volume and counter element inversion.
