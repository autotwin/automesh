...
For any hexahedral element that has a negative Jacobian, we seek to maximize the Jacobian energy term $J$, which will tend to move the Jacobian from negative to positive (untangling).
