...
See the [Smoothing Theory](theory/smoothing.md) section for more information.
...
quadrilateral faces are divided into two triangles.  The [Isosurface](theory/isosurface.md) section contains more details about alternative methods used to create an isosurface.
